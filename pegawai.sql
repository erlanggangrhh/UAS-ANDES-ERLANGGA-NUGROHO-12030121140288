...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2022 at 04:42 AM
...
CREATE TABLE `cuti` (
  ...
  `status` enum('Disetujui HRD','Ditolak HRD','Disetujui Atasan','Ditolak Atasan','Diproses') COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'App\\Models\\Pegawai', 22120001),
(2, 'App\\Models\\Pegawai', 22120002),
(3, 'App\\Models\\Pegawai', 22120003);
...
(22120001, 1, '3171930204997285', 'Yessi Prastuti', 'Pria', 'Protestan', 'Serang', '1998-03-05', 'Gg. Qrisdoren No. 313', 'Ds. Antapani Lama No. 149', 'Menikah', 5, '028 6311 374', 'admin@gmail.com', '$2y$10$8A4zj2KEuNCd2hLKZLe1Bu2vAeCNkF8hnw.r.wa4qjOQT6UGQgB2.', '2010-11-30', NULL, 6, 2, 'foto.jpg', NULL, '2022-12-08 20:41:02', '2022-12-08 20:41:02', NULL),
(22120002, 2, '1612957101162351', 'Cinta Yolanda S.I.Kom', 'Pria', 'Protestan', 'Pekalongan', '1997-06-28', 'Jln. Babah No. 960', 'Gg. Baabur Royan No. 853', 'Menikah', 5, '(+62) 774 8848 921', 'hrd@gmail.com', '$2y$10$2s6twQmDy1VQtczP3llUKu19AX60k873RrWHCcFWoDyZ0enR.cr1a', '1973-03-30', NULL, 6, 2, 'foto.jpg', NULL, '2022-12-08 20:41:02', '2022-12-08 20:41:02', NULL),
(22120003, 3, '7401113110950108', 'Daryani Sihotang', 'Pria', 'Islam', 'Bukittinggi', '1975-01-18', 'Jln. Tambun No. 837', 'Jr. Cihampelas No. 108', 'Menikah', 0, '(+62) 240 4369 2632', 'staff@gmail.com', '$2y$10$QHcDeiNXpCmQObuIIjFkpu6p2STLipIie4sT8VONbd3Qb23Y8bpaO', '2009-08-22', NULL, 6, 4, 'foto.jpg', NULL, '2022-12-08 20:41:02', '2022-12-08 20:41:02', NULL);
...
(1, 'dashboard-admin', 'web', '2022-12-08 20:41:02', '2022-12-08 20:41:02'),
(2, 'dashboard-hrd', 'web', '2022-12-08 20:41:02', '2022-12-08 20:41:02'),
(3, 'menu-staff', 'web', '2022-12-08 20:41:02', '2022-12-08 20:41:02'),
(4, 'manajemen-role', 'web', '2022-12-08 20:41:02', '2022-12-08 20:41:02'),
(5, 'menu-kebijakan-kantor', 'web', '2022-12-08 20:41:02', '2022-12-08 20:41:02'),
(6, 'menu-pegawai', 'web', '2022-12-08 20:41:02', '2022-12-08 20:41:02'),
(7, 'menu-jabatan', 'web', '2022-12-08 20:41:02', '2022-12-08 20:41:02'),
(8, 'menu-divisi', 'web', '2022-12-08 20:41:02', '2022-12-08 20:41:02'),
(9, 'menu-presensi', 'web', '2022-12-08 20:41:02', '2022-12-08 20:41:02'),
(10, 'menu-cuti', 'web', '2022-12-08 20:41:02', '2022-12-08 20:41:02'),
(11, 'menu-gaji', 'web', '2022-12-08 20:41:02', '2022-12-08 20:41:02'),
(12, 'menu-surat-peringatan', 'web', '2022-12-08 20:41:02', '2022-12-08 20:41:02'),
(13, 'menu-export-kinerja', 'web', '2022-12-08 20:41:02', '2022-12-08 20:41:02'),
(14, 'manajemen-perusahaan', 'web', '2022-12-08 20:41:02', '2022-12-08 20:41:02');
...
CREATE TABLE `perusahaan` (
  ...
  `email_public` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `path_logo` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'ADMIN', 'web', '2022-12-08 20:41:02', '2022-12-08 20:41:02'),
(2, 'HRD', 'web', '2022-12-08 20:41:02', '2022-12-08 20:41:02'),
(3, 'STAFF', 'web', '2022-12-08 20:41:02', '2022-12-08 20:41:02');
...
CREATE TABLE `surat_peringatan` (
  ...
  `id_pegawai` bigint(20) UNSIGNED NOT NULL,
  `tanggal` date NOT NULL,
  `tingkat` enum('I','II','III') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
ALTER TABLE `pegawai`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22120004;
